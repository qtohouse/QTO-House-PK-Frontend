      ...
      >
        ...
        <Box sx={{
          ...
          <motion.div custom={0} variants={contentVariants}>
            <motion.div whileHover="hover" variants={iconVariants}>
              <Box sx={{
                ...
                <FlagIcon sx={{ fontSize: { xs: 28, sm: 32, md: 36, lg: 40, xl: 44 }, color: theme.palette.primary.main }} />
              </Box>
            </motion.div>
          </motion.div>
          ...
          <motion.div custom={2} variants={contentVariants}>
            ...
            >
              To empower construction companies in Northern America with precise take-offs and cost estimations, offering tailored solutions and project leads.
            </Typography>
          </motion.div>
        </Box>
      </Box>
